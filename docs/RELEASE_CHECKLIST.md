...
release sign-off. Commit `a7599bb2c368fffcaa9918c8794088d5d6c12992`
...
| Production package | `local-markdown-vault-0.2.0.vsix`: 57 files, 3.48 MB (3,652,838 compressed bytes; 14,329,275 uncompressed bytes); archive verifier passed after a clean `npm ci --ignore-scripts`, including the packaged Obsidian compatibility contract |
| VSIX SHA-256 | `bf7a475d1538b6d05b2e0c9d7572e428cc0cced1ea7077ccaadcc8eaac0b6230` |
